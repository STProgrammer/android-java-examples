package com.wfamedia.albumsforuser2021utvidet.repository;
...
public class AlbumsRepository {
    ...
    public MutableLiveData<List<Album>> getAlbumsForUser(int userId, boolean forceReload) {
        if (!forceReload && albumsData.getValue() != null && albumsData.getValue().size() > 0)
            return albumsData;
