package com.wfamedia.location4;
...
import com.wfamedia.location4.R;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void initMap() {
        ...
        startMarker.setIcon(getResources().getDrawable(R.drawable.ic_geopoint, null));
        ...
        final MapEventsReceiver mReceive = new MapEventsReceiver(){
            ...
            public boolean singleTapConfirmedHelper(GeoPoint geoPoint) {
                ...
                marker.setIcon(getResources().getDrawable(R.drawable.ic_geopoint2, null));
