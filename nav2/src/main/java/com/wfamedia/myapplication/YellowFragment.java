    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        btnNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // Uten bruk av Actions og SafeArgs:
                //navController.navigate(R.id.yellowFragment);

                // Med bruk av Actions og SafeArgs:
                NavDirections navDirections = YellowFragmentDirections.actionYellowToBlue();
        ...
        btnDialog.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                NavController navController = Navigation.findNavController(view);
                // Med bruk av Actions og SafeArgs:
                YellowFragmentDirections.ActionYellowToDialog actionYellowToDialog = YellowFragmentDirections.actionYellowToDialog();
                actionYellowToDialog.setDialogTitle("Demodialog");
                actionYellowToDialog.setDialogText("Dette er dialogteksten.");
                navController.navigate(actionYellowToDialog);
            }
        });
        ...
        btnBackToStart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                NavController navController = Navigation.findNavController(view);
                navController.navigate(R.id.actionBackToStart, null);
            }
        });
